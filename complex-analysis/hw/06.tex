...
\end{align*}
Since $\cos(4\theta)$ is a real number, it's safe to eliminate the imaginary component of this result.
Thus,
\begin{align*}
...
Thus, $$x \in \left\{\frac{\sqrt{2-\sqrt2}}2, \frac{\sqrt{2+\sqrt2}}2, -\frac{\sqrt{2-\sqrt2}}2, -\frac{\sqrt{2+\sqrt2}}2\right\}.$$

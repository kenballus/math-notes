...
\node at (0.309, 1.301) {$x$};
\draw[fill=white] (-0.809, 0.588) circle (3pt);
\node at (-0.809, 0.938) {$y$};
\draw[fill=white] (-0.809, -0.588) circle (3pt);
\node at (-1, -0.238) {$v$};
\draw[fill=white] (0.309, -0.951) circle (3pt);
\node at (0.309, -0.601) {$w$};
...
\draw (1.0, 0.0) -- (0.5, 0.866);
\draw (1.0, 0.0) -- (-1.0, 0.0);
\draw (1.0, 0.0) -- (-0.5, 0.866);
\draw (0.5, 0.866) -- (-0.5, 0.866);
\draw (0.5, 0.866) -- (-0.5, -0.866);
\draw (0.5, 0.866) -- (1.0, 0.0);
\draw (-0.5, 0.866) -- (0.5, 0.866);
\draw (-0.5, 0.866) -- (-0.5, -0.866);
\draw (-0.5, 0.866) -- (0.5, -0.866);
\draw (-0.5, 0.866) -- (1.0, 0.0);
...
\draw (0.5, -0.866) -- (-0.5, -0.866);
\draw (0.5, -0.866) -- (-1.0, 0.0);
\draw plot [smooth] coordinates {(-0.5, 0.866) (-0.7, 0) (-0.5, -0.866)};
\end{tikzpicture}

\medskip
{\bf (b)} The solution in (a) is changed only by adding a $2-2$ loop.
...
\draw[fill=white] (3.0, 0.0) circle (3pt);
\node at (3.0, 0.35) {$1$};
\draw[fill=white] (2.598, 1.5) circle (3pt);
\node at (2.598, 1.85) {$4$};
\draw[fill=white] (1.5, 2.598) circle (3pt);
\node at (1.5, 2.948) {$7$};
\draw[fill=white] (0.0, 3.0) circle (3pt);
\node at (0.0, 3.35) {$2$};
\draw[fill=white] (-1.5, 2.598) circle (3pt);
...
\node at (-2.598, -1.15) {$6$};
\draw[fill=white] (-1.5, -2.598) circle (3pt);
\node at (-1.5, -2.2479999999999998) {$8$};
\draw[fill=white] (-0.0, -3.0) circle (3pt);
\node at (0.0, -2.65) {$10$};
\draw[fill=white] (1.5, -2.598) circle (3pt);
\node at (1.5, -2.2479999999999998) {$12$};
\draw[fill=white] (2.598, -1.5) circle (3pt);
\node at (2.598, -1.15) {$11$};

\draw[->] (3.0, 0.0) -- (2.598, 1.5);
% \draw[thick] (3.0, 0.0) -- (-0.0, -3.0);
% \draw[thick] (3.0, 0.0) -- (1.5, 2.598);
% \draw[thick] (2.598, 1.5) -- (-0.0, -3.0);
% \draw[thick] (2.598, 1.5) -- (3.0, 0.0);
% \draw[thick] (2.598, 1.5) -- (1.5, 2.598);
% \draw[thick] (1.5, 2.598) -- (2.598, 1.5);
% \draw[thick] (1.5, 2.598) -- (3.0, 0.0);
% \draw[thick] (1.5, 2.598) -- (-0.0, -3.0);
% \draw[thick] (0.0, 3.0) -- (-2.598, 1.5);
% \draw[thick] (0.0, 3.0) -- (1.5, -2.598);
% \draw[thick] (0.0, 3.0) -- (-1.5, 2.598);
% \draw[thick] (-1.5, 2.598) -- (-2.598, 1.5);
% \draw[thick] (-1.5, 2.598) -- (1.5, -2.598);
% \draw[thick] (-1.5, 2.598) -- (0.0, 3.0);
% \draw[thick] (-2.598, 1.5) -- (1.5, -2.598);
% \draw[thick] (-2.598, 1.5) -- (0.0, 3.0);
% \draw[thick] (-2.598, 1.5) -- (-1.5, 2.598);
% \draw[thick] (-3.0, 0.0) -- (-1.5, -2.598);
% \draw[thick] (-3.0, 0.0) -- (2.598, -1.5);
% \draw[thick] (-3.0, 0.0) -- (-2.598, -1.5);
% \draw[thick] (-2.598, -1.5) -- (-3.0, 0.0);
% \draw[thick] (-2.598, -1.5) -- (-1.5, -2.598);
% \draw[thick] (-2.598, -1.5) -- (2.598, -1.5);
% \draw[thick] (-1.5, -2.598) -- (-3.0, 0.0);
% \draw[thick] (-1.5, -2.598) -- (2.598, -1.5);
% \draw[thick] (-1.5, -2.598) -- (-2.598, -1.5);
% \draw[thick] (-0.0, -3.0) -- (2.598, 1.5);

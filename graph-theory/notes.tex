...
\medskip\noindent\textbf{Theorem 10.12 - Vizing's Theorem}
    ...
    Graphs with chromatic number equal to their maximum vertex degree are known as graphs of class 1.
    Graphs with chromatic number equal to one more than their maximum vertex degree are known as graphs of class 2.
    We will not prove this.
...
\medskip\noindent\textbf{Theorem 10.13}
    ...
    Thus, $G$ is $r$-regular if and only if $G$ is 1-factorable.

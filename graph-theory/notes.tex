...
\medskip\noindent\textbf{Domination}
    ...
    A vertexx dominates its closed neighborhood.
    ...
    The domination number for a bipartite graph that is not a star is 2.
...
\medskip\noindent\textbf{Theorem 13.4}
    ...
    If $S$ isa  minimal dominating set for a graph that has no isolated vertices, then its complement is a dominating set.

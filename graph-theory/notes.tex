...
\medskip\noindent{\bf A Better Theorem than 2.3}

    If $G \cong H$, then for any (induced) subgraph $G'$ of $G$, there exists an (induced) subgraph $H'$ of $H$ with the same degree sequence as $G'$.

...
\medskip
\noindent{\bf a.} Impossible. % But maybe a voice memos logo situation is possible?

\medskip
\noindent{\bf b.} $f(x) = \sin(\pi x) + 1$

\medskip
\noindent{\bf c.} % Possible. Something with infinite oscillations and a constant baseline at 0, but the tops of the curves get closer and closer to 2 as x goes to 0.
